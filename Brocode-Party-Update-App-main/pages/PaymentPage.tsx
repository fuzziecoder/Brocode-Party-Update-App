...
const PaymentPage: React.FC = () => {
  ...
  // If user has extras, they pay for extras only. Otherwise, they pay the spot budget.
  const totalAmount = myDrinkTotal > 0 ? myDrinkTotal : spotAmount;
  ...
  const handleMarkPaid = async (paymentId: string) => {
    ...
    try {
      ...
      if (payment && spot) {
        ...
        const totalUserAmount = userDrinkCost > 0 ? userDrinkCost : spot.budget;
        ...
        <Card className="flex flex-col items-center text-center p-4 md:p-6">
          ...
          <div className="mt-4 w-full">
            ...
            <p className="text-sm text-gray-400">
              {myDrinkTotal > 0
                ? `(Includes extras: ₹${myDrinkTotal}. Fixed budget removed.)`
                : `(Fixed Spot Budget: ₹${spotAmount})`}
            </p>
          </div>
            ...
            <div className="space-y-3">
              {payments
                ...
                .map((payment) => {
                  ...
                  // Apply same logic: If extras exist, pay only extras. Else pay spot budget.
                  const memberTotalAmount = memberDrinkTotal > 0 ? memberDrinkTotal : spot.budget;
