...
export interface UserProfile {
  ...
  is_sponsor?: boolean; // Permanent badge flag
  sponsor_count?: number; // Total spots sponsored
...
export interface Spot {
  ...
  sponsored_by?: string;
  sponsor?: UserProfile; // Joined data
}
...
export interface Payment {
  ...
  bill_confirmed?: boolean; // Admin-confirmed bill
}
...
export interface ChatMessage {
  ...
  created_at: string; // ISO String
  profiles: Pick<UserProfile, 'name' | 'profile_pic_url' | 'is_sponsor'>; // Joined data
